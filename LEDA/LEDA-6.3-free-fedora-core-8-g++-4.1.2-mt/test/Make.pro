...
CC      = g++$(VERS) -march=i486 -pthread -Wall -Wfatal-errors --warn-error -DLEDA_MULTI_THREAD
PLAIN_C = gcc$(VERS) -march=i486 -pthread -Wall
CCLIB   = g++$(VERS) -march=i486 -pthread -shared
LD      = g++$(VERS) -march=i486 -pthread
